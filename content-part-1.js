...
// This file contains the complete HTML structure and all CSS styles
...
(function() {
    ...
    // Background image from Cloudflare Pages
    const BACKGROUND_IMAGE = 'https://myprojec-37j.pages.dev/background-image.png';
    
    // Document icon from Cloudflare Pages
    ...
    // Complete HTML template with all CSS and structure
    const HTML_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        /* ============================================================ */
        /* ALL CSS INLINE - No external CSS file needed */
        /* ============================================================ */
        ...
        * {
        ...
        .action-btn:hover {
            background: #154a7a;
            box-shadow: 0 4px 12px rgba(30, 95, 158, 0.25);
        }
...
<script>
    ...
    console.log('📸 Images loaded from Cloudflare Pages:');
